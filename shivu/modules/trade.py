...
async def trade(client, message):
    ...
    sender_character_id = message.command[1].zfill(4)
    receiver_character_id = message.command[2].zfill(4)
...
async def gift(client, message):
    ...
    if not message.reply_to_message:
        await message.reply_text("✳️ ʏᴏᴜ ɴᴇᴇᴅ ᴛᴏ ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴜꜱᴇʀ'ꜱ ᴍᴇꜱꜱᴀɢᴇ ᴛᴏ ɢɪꜰᴛ ᴀ ᴄʜᴀʀᴀᴄᴛᴇʀ!")
        return
    ...
    character_id = message.command[1].zfill(4)
